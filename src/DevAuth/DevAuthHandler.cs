...
{
    internal sealed class DevAuthHandler : RemoteAuthenticationHandler<DevAuthOptions>
    {
        private static readonly DateTime Epoch = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        public const string StateCookie = "__DevAuthState";
   //     public const string RequestTokenCookie = "__RequestToken";
        ...
        public DevAuthHandler(HttpClient httpClient)
        {
        ...
        {
            var context = new DevAuthCreatingTicketContext(Context, Options, token.UserId, token.ScreenName, token.Token, token.TokenSecret, user)
            {
        ...
        private async Task<RequestToken> ObtainRequestTokenAsync(string callBackUri, AuthenticationProperties properties)
        {
            ...
            var data = Options.StateDataFormat.Protect(requestToken);
            var data2 = Options.StateDataFormat.Unprotect(data);
        ...
        private async Task<RequestToken> ObtainRequestTokenAsync(string callBackUri, AuthenticationProperties properties)
        {
            ...
            {
                throw new Exception("DevAuth oauth_callback_confirmed is not true.");
            }
        ...
        */
        ...
        {
            // https://dev.DevAuth.com/docs/api/1/post/oauth/access_token
        ...
        // https://dev.DevAuth.com/rest/reference/get/account/verify_credentials
        private async Task<JObject> RetrieveUserDetailsAsync(AccessToken accessToken, ClaimsIdentity identity)
        {
            ...
            var resource_url = "https://api.DevAuth.com/1.1/account/verify_credentials.json";
