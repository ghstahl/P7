...
{
    /// <summary>
    /// Serializes and deserializes DevAuth request and access tokens so that they can be used by other application components.
    /// </summary>
    public class RequestTokenSerializer : IDataSerializer<RequestToken>
    {
        ...
        /// <returns>The DevAuth request token</returns>
        ...
        /// <summary>
        /// Writes a DevAuth request token as a series of bytes. Used by the <see cref="Serialize"/> method.
        /// </summary>
        ...
        /// <summary>
        /// Reads a DevAuth request token from a series of bytes. Used by the <see cref="Deserialize"/> method.
        /// </summary>
